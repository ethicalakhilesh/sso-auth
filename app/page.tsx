        ...
        <aside className="nova-sidebar">
          <div>
            ...
            >
              <a
                href="#top"
                className="nova-nav-item active"
              >
                <HomeIcon />
                <span>Home</span>
              </a>
          ...
          <div className="nova-sidebar-bottom">
            ...
            <div className="nova-account-mini">
              ...
              <div className="min-w-0">
                <div className="account-name truncate">
                  {displayName}
                </div>

                <div className="account-email truncate">
                  {user.username}
                </div>
              </div>
        ...
        >
          <header className="nova-topbar">
            <div className="nova-search">
              ...
              <span>
                Search for apps, users, or settings...
              </span>
          ...
          <div className="nova-main">
            <div className="nova-heading-row">
              <div>
                ...
                <p className="nova-subtitle">
                  Access your applications or manage the SSO
                  system.
                </p>
              </div>
            ...
            <div className="nova-grid-main">
              <div className="nova-left-column">
                ...
                >
                  <div className="panel-heading">
                    <div>
                      ...
                      <p>
                        Launch the applications assigned to
                        you.
                      </p>
                    </div>
                ...
                >
                  ...
                  {history.length === 0 ? (
                    <div className="empty-state">
                      No sign-in history yet — it will
                      appear after your next login.
                    </div>
                  ) : (
            ...
            <footer className="nova-footer">
              <span>
                NOVA SSO v1.0.0 · Secure identity for
...
/**
 * Renders the SVG icon stored in Airtable.
 *
 * Airtable field:
 *   Clients.appSvgCode
 *
 ...
 *
 * If the field is empty or does not contain an SVG root element,
 * we fall back to the application's first letter.
 *
 * IMPORTANT:
 * Only trusted SVG markup should be stored in Airtable.
 */
function AppIcon({
  name,
  svgCode,
...
/**
 * Lightweight validation for the Airtable SVG field.
 *
 * This is not intended to be a complete HTML/SVG sanitizer.
 * It simply prevents obviously unsafe markup from being injected
 * into the page and requires a real <svg> root element.
 *
 * Keep appSvgCode restricted to administrators.
 */
...
function NovaMark() {
  return (
    ...
    >
      ...
      <path
        d="M20 2v7M20 31v7M2 20h7M31 20h7M7.3 7.3l5 5M27.7 27.7l5 5M32.7 7.3l-5 5M12.3 27.7l-5 5"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
...
function UsersIcon() {
  return (
    <Icon>
      ...
      <path d="M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6M17 5.5a3 3 0 0 1 0 5.8M17 14c2.5.3 4 2.3 4 5" />
    </Icon>
  );
}
...
function SettingsIcon() {
  return (
    <Icon>
      ...
      <path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-1.8 1.8-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6V20h-2.6v-.2a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1-1.8-1.8.1-.1A1.7 1.7 0 0 0 8.2 15a1.7 1.7 0 0 0-1.6-1H6v-2.6h.6a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9l-.1-.1 1.8-1.8.1.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.6V4h2.6v.6a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1 1.8 1.8-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.6V14h-.6a1.7 1.7 0 0 0-1.6 1Z" />
    </Icon>
  );
}
  ...
  return (
    <Icon>
      <circle
        ...
        r="9"
      />
      <path d="M9.7 9a2.4 2.4 0 1 1 4.3 1.5c-.8 1-2 1.3-2 2.8" />
      <path d="M12 17h.01" />
    </Icon>
  );
}
